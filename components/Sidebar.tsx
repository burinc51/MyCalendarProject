...
const SIDEBAR_WIDTH = Math.min(SCREEN_WIDTH * 0.80, 300);
...
const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
        ...
        >
            ...
            >
                {/* ── Profile Header ── */}
                <View style={[styles.header, { backgroundColor: C.headerTop }]}>
                    {/* Decorative circles */}
                    ...
                    {/* Subtitle */}
                    <Text style={styles.subText}>ดูโปรไฟล์</Text>
                </View>
                ...
                <View style={[styles.footer, { backgroundColor: C.footerBg, borderTopColor: C.divider }]}>
                    <TouchableOpacity style={styles.footerItem} activeOpacity={0.7}>
                        ...
                        <Text style={[styles.footerItemText, { color: C.footerText }]}>ตั้งค่า</Text>
                    </TouchableOpacity>
                    <View style={[styles.footerDivider, { backgroundColor: C.divider }]} />
                    <TouchableOpacity style={styles.footerItem} activeOpacity={0.7}>
                        <Feather name="log-out" size={17} color="#ef4444" />
                        <Text style={[styles.footerItemText, { color: '#ef4444' }]}>ออกจากระบบ</Text>
                    </TouchableOpacity>
                </View>
            </Animated.View>
        </Modal>
